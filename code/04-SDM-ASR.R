## ABIOTIC-BIOTIC SPECIES RICHNESS MODEL
...
# extract model environment values for occurrences
...
# save model as RData
#saveRDS(mn, file = './results/SDM_ASR.RData')
...
write.csv(test, "./pROC/testdata_ASR.csv")
writeRaster(pred.mn, "./pROC/SDM_ASR.asc", overwrite=TRUE)

proc <- PartialROC(PresenceFile="./pROC/testdata_ASR.csv", 
                   PredictionFile="./pROC/SDM_ASR.asc", 
                   OmissionVal=0.1, 
                   RandomPercent=50, 
                   NoOfIteration=1000,
                   OutputFile="./pROC/TestRoc_SDM_ASR.csv") 
